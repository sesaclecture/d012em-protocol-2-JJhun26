...
def read_imu() -> Dict[str, int]:
    ...
    with SMBus(1) as bus:
        ...
        ax, ay, az = (_read_word(bus,Mpu6050Reg.ADDR,Mpu6050Reg.ACCEL_XOUT_H + i ) for i in range(0,5,2))
        gx, gy, gz = (_read_word(bus,Mpu6050Reg.ADDR,Mpu6050Reg.GYRO_XOUT_H + i ) for i in range(0,5,2))
...
def ssh_get_arch() -> str:
    ...
    user_host = "jihun@192.168.100.68"
    cmd = "uname -m"
